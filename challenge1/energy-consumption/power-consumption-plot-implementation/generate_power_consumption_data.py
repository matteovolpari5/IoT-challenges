...
segments = [
    ...
    (182801,   724.58),  # WiFi on, before transimission
    (59.60,    797.29),  # transmission
    (5900,     724.58),  # WiFi on, after transmission
    (100000,      59.66)    # deep sleep
]
...
# create csv file
with open("power_profile.csv", "w", newline="") as csvfile:
...
print("File successfully created: power_profile.csv")
